<template>
    <div class="flex flex-row h-10 w-full rounded-lg relative bg-gray-50 mt-1 border border-gray-300">
        <button @click="decreaseFloorNumber" class=" bg-transparent text-gray-900 hover:bg-gray-200 h-full w-20 rounded-l cursor-pointer outline-none">
        ...
        <button @click="increaseFloorNumber" class="bg-transparent text-gray-900 hover:bg-gray-200 h-full w-20 rounded-r cursor-pointer">
